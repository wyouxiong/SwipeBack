...
public class SwipeBackLayout extends RelativeLayout {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        switch (dragEdge) {
            case LEFT:
                mShadow.setBounds(target.getLeft() - mShadow.getIntrinsicWidth(), target.getTop(), target.getLeft(), target.getBottom());
                break;
            case RIGHT:
                mShadow.setBounds(target.getRight(), target.getTop(), target.getRight() + mShadow.getIntrinsicWidth(), target.getBottom());
                break;
            case TOP:
                mShadow.setBounds(target.getLeft(), target.getTop() - mShadow.getIntrinsicHeight(), target.getRight(), target.getTop());
                break;
            case BOTTOM:
                mShadow.setBounds(target.getLeft(), target.getBottom(), target.getRight(), target.getBottom() + mShadow.getIntrinsicHeight());
                break;
        }
